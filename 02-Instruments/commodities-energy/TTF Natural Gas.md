---
aliases: [TTF, Title Transfer Facility, Dutch TTF]
tags:
  - "#energy/natgas/ttf"
...
| Exchange | ICE Endex |
| Ticker | TFM (monthly) |
| Contract Size | 1 lot = 1 MWh/day for the delivery period |
| Tick Size | EUR 0.001/MWh |
| Tick Value | varies by contract period |
| Trading Hours | 07:00 to 17:00 CET |
| Settlement | Physical (title transfer at TTF hub) |
| Expiry Months | Monthly, quarterly, seasonal, calendar |
| Currency | EUR |
...
- **TTF/NBP:** European hub vs UK hub differential
- **TTF/Henry Hub + shipping:** transatlantic LNG arbitrage, the key global gas relative value
- **TTF/JKM:** Europe vs Asia LNG competition (JKM = Japan Korea Marker)
- **TTF/Coal spread:** fuel switching economics in power generation
...
- Carbon price linkage (EU ETS affects gas competitiveness vs coal)

## Trading Notes

*Add personal observations here as you learn more about TTF.*

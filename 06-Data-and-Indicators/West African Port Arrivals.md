---
aliases: [Ivory Coast arrivals, Ghana arrivals, cocoa port arrivals, Abidjan arrivals, San Pedro arrivals, COCOBOD purchases, cocoa arrivals data]
tags:
  - "#agri/softs/cocoa"
date-added: "2026-03-24"
---

# West African Port Arrivals
...
**Data source:** Estimates compiled by exporters and news agencies (Reuters, Bloomberg). Not an official government publication, but widely followed.

**Publication:** Weekly, typically Monday or Tuesday. Covers the prior week (Monday to Sunday).
...
- Divergence between official purchases and estimated production (indicates smuggling or informal trade)
- COCOBOD forward sales: the board pre sells a portion of the crop via forward contracts. If production falls short, COCOBOD faces delivery defaults, a major systemic risk.
...
- Reuters: Weekly Ivory Coast cocoa arrivals estimates
- Bloomberg: Cocoa port arrivals data
- Ghana Cocoa Board (COCOBOD): Seasonal purchase reports
- Ecom Agroindustrial, Olam, Barry Callebaut: Industry crop estimates
- ICCO: Monthly Cocoa Market Review (incorporates arrivals trends)

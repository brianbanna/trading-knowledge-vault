...
## Concrete example
**Concrete:** USD/JPY 1 week ATM straddle quoted at 10.5% implied vol (85 pips premium) ahead of a BOJ meeting. Trader buys at strike 150.50. BOJ unexpectedly raises rates 25 bp, USD/JPY drops to 147.00 in 2 days. Put leg has 350 pips intrinsic. Net profit 265 pips. Realized vol over the week annualizes at 22%, far above the 10.5% implied. Counter case: trader buys 1 month EUR/USD straddle at 8.2% implied for 115 pips. Next month is quiet: spot drifts from 1.0800 to 1.0830. Realized vol 5.8%. At expiry the call has 30 pips intrinsic, net loss 85 pips. [[Theta]] consumed time value, [[Gamma]] gains from small daily moves (delta hedged) could not compensate.
